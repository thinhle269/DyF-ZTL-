...
def load_and_process_data(filepath, num_clients=10, non_iid_alpha=0.5):
    ...
    try:
        # low_memory=False de tranh warning
    ...
    # === FIX 1: FORCE NUMERIC (Xu ly loi ValueError) ===
    # Ep kieu so, bien khoang trang thanh NaN
    ...
    # === FIX 2: Sửa lỗi IndexError o day (dung len() thay vi shape[1]) ===
